...
<head>
  ...
  <title>Login &mdash; LuckyDraw</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
              ...
              <div class="card-body">
                <form method="post" action="{{ route('login') }}" class="needs-validation">
                  ...
                  <div class="form-group">
                    ...
                    <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="Email" tabindex="1" required autofocus>
                    @error('email')
            ...
            <div class="simple-footer">
              Copyright &copy; luckydraw {{ now()->year }}
            </div>
          </div>
        </div>
      </div>
